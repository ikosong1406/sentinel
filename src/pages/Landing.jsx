        ...
        <div className="landMain">
          ...
          >
            <div className="landDiv11">
              <h1>
                Best Way to Secure Your Assets with{" "}
                <span style={{ color: "goldenrod" }}>Sentinel</span>
              </h1>
              <h3>
                Sentinel is a cutting-edge decentralized digital security system
                designed to revolutionize the way you secure your finances. In
                ...
                <div className="landDiv2131">
                  <div className="landDiv2132">
                    <div className="landDiv21321">
                      <h3 className="date">Decentralized Security</h3>
                      <h4>
          ...
          >
            <div className="landDiv41">
              ...
              <div className="landDiv411">
                ...
                <div className="landDiv4111">
                  ...
                  <p>
                    We support multi currency. Secure Assets from the convinence
                    of your closet
                  </p>
                </div>
                <div className="landDiv4111">
            ...
            <div className="landDiv5">
              <div className="landDiv51">
                <h1>ABOUT US</h1>
                <h3>
                  Sentinel is an advanced financial system launched to eradicate
                  monopoly on monetary system and for that purpose, a system
                  comprises of artificial Intelligence and complex computer
                  programs fully backed by banks is needed. Sentinel will not be
                  influenced by Government policies, rather it will be entirely
                  backed by tangible assets like Gold, Platinum, Oil and will
                  not be based upon mere piece of papers which have no
                  evidentiary value.
                </h3>
                <Link to="/register" className="landDiv1Btn">
                  Contact us
          ...
          >
            <div className="landDiv71">
              <h1>
                Sentinel Financial System is the next stage of financial
                security.
              </h1>
              <h3>
                ...
                legislations. Sentinel has no competitors, and it's going to
